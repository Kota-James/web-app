...
const LeadModal = ({active, handleModal, token, id, setErrorMessage}) => {
    ...
    const handleUpdateLead = async (e) => {
        ...
        const response = await fetch(`/api/leads/${id}`, requestOptions)
        if(!response.ok){
            setErrorMessage("Something went wronf ehen updating lead")
        }else{
            cleanFormData();
            handleModal();
        }
    ...
    return(
        <div className={`modal ${active && "is-active"}`}>
            ...
            <div className="modal-card">
                <header className="modal-card-head has-background-gray-dark">
                ...
                <footer className="modal-card-foot has-background-gray-dark">
                    {id ? (
